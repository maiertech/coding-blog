...
[Radix Primitives](https://radix-ui.com/) are what Headless UI strives to be.
They can be styled with anything, including Tailwind CSS, but the preferred way
is their own [Stitches](https://stitches.dev/). Stitches is similar to Styled
System or Theme UI with a different syntax to access design tokens.

This feels like the reincarnation of Styled System/Theme UI with unstyled
components. Definitley an elegant way to build a component library but with they
full risk of running into the same issues with
