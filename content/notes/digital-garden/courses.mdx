---
title: Online course examples
description: Example for good free and paid online courses.
tags:
  - digital-garden
---
...
Josh Comeau built his course platform on Next.js:

- Stack: MDX, Next.js and MongoDB.
- He has managed to do everything with Next, via API routes and SSR.
- MDX is the most critical piece. It allows him to create and embed one-off
  components, like the interactive widgets, the minigames.

His cost are about $450 a month. ConvertKit is the biggest, at $260 a month (28k
subscribers). He uses Vercel for hosting and so it's a ridiculously cheap $20 a
month. MongoDB is $50 a month, Sentry is $20 a month.
