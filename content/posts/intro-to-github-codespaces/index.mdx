...
date: 2021-01-03
description:
  In this post I give an introduction to GitHub Codespaces, a service to run dev
  environments as Docker containers in the cloud and access them with VS Code.
  The configs used for Codespaces can also be used to run dev containers
  locally. This creates a next generation development experience that makes it
  possible to contribute to GitHub repositories without the need to setup a
...
tags:
  ...
  - github
  - docker
dev: https://dev.to/maiertech/introduction-to-github-codespaces-4l74
twitter: https://twitter.com/maiertech/status/1357331827652874242
---
...
The service comes with a promise of lowering the barrier to contributing to
