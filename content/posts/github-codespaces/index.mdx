...
Let's look at the
[`devcontainer.json` of the GitHub repository that I use to publish coding.maier.dev](https://github.com/454de6e/coding-garden/blob/master/.devcontainer/devcontainer.json):
