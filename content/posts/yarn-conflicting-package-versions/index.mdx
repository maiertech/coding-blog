...
date: 2021-02-19
description:
  Yarn 1 uses hoisting to eliminate nodes from the dependency tree. This post
  discusses examples of how to use `yarn why` and the yarn.lock file to
  understand how Yarn hoists dependencies and deals with conflicting package
  versions.
tags:
  - node
  - webdev
  - yarn
tweets:
  - https://twitter.com/maiertech/status/1362976542733705216
  - https://twitter.com/maiertech/status/1364560714560540675
---
...
dependencies and pinned it to a previous version 4.16.2. This changed things
quite a bit:
...
- Hoisting can conceal missing dependencies. Hoisted dependencies can be
  ...
  because of something as minor as a pinned dependency.
- Yarn always
